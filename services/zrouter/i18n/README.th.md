...
<div align="center">
  <img src="../images/zrouter.png?1" alt="แดชบอร์ด zRouter" width="800"/>
  
  # zRouter - Free AI Router
  ...
  **ผู้ให้บริการ AI ฟรีสำหรับ OpenClaw**
  ...
  [🚀 เริ่มต้นใช้งาน](#-quick-start) • [💡 ฟีเจอร์](#-key-features) • [📖 การตั้งค่า](#-setup-guide) • [🌐 เว็บไซต์](https://zrouter.com)
</div>
...
Repo นี้เป็น private package (`zrouter-app`) ดังนั้นการรันจากซอร์ส/Docker คือเส้นทางพัฒนาท้องถิ่นที่คาดไว้
...
zRouter ทำงานได้อย่างราบรื่นกับเครื่องมือเขียนโค้ด AI ทุกประเภท:
...
Headroom เป็นตัวเลือกและทำงานแยกกัน zRouter เรียก endpoint `/v1/compress` ของ Headroom จากนั้นยังคงเลือกเส้นทาง, fallback, auth และติดตามการใช้งานตามปกติ:
...
ถ้า Headroom ดับหรือคืน error, zRouter จะ fail open และส่งคำขอต้นฉบับ
...
- เครื่องมือ CLI ของคุณส่งรูปแบบ OpenAI → zRouter แปลง → ผู้ให้บริการได้รับรูปแบบต้นฉบับ
...
<details>
<summary><b>💳 zRouter เก็บเงินฉันหรือไม่?</b></summary>

**ไม่.** zRouter เป็นซอฟต์แวร์ฟรีแบบ open source ที่ทำงานบนเครื่องของคุณเอง มันไม่มีวันเรียกเก็บเงินจากคุณ

**คุณจ่ายเงินเฉพาะ:**
- ✅ **ผู้ให้บริการสมาชิก** (Claude Code $20/เดือน, Codex $20-200/เดือน) → จ่ายตรงให้พวกเขาบนเว็บไซต์ของพวกเขา
- ✅ **ผู้ให้บริการราคาถูก** (GLM, MiniMax) → จ่ายตรงให้พวกเขา, zRouter แค่เลือกเส้นทางคำขอของคุณ
- ❌ **ตัว zRouter เอง** → **ไม่มีวันเรียกเก็บเงินใดๆ ทั้งสิ้น**

zRouter เป็น proxy/router ท้องถิ่น มันไม่มีบัตรเครดิตของคุณ, ไม่สามารถส่งใบแจ้งหนี้ได้ และไม่มีระบบชำระเงิน เป็นซอฟต์แวร์ฟรีทั้งหมด
...
zRouter แค่เลือกเส้นทางคำขอของคุณไปหาพวกเขา — ไม่มี "กับดัก" หรือการเรียกเก็บเงินในอนาคต เป็นบริการที่ฟรีจริงๆ และ zRouter ทำให้ใช้งานง่ายด้วยการรองรับ fallback
...
3. **ใช้ผู้ให้บริการสมาชิก** ก็ต่อเมื่อมีอยู่แล้ว:
   - zRouter ช่วยเพิ่มประสิทธิภาพมูลค่าของพวกเขาผ่านการติดตามโควตา
...
- **เว็บไซต์**: [zrouter.com](https://zrouter.com)
...
ขอขอบคุณผู้มีส่วนร่วมทุกคนที่ช่วยทำให้ zRouter ดียิ่งขึ้น!

[![Contributors](https://contrib.rocks/image?repo=decolua/zrouter&max=150&columns=15&anon=1)](https://github.com/decolua/zrouter/graphs/contributors)
