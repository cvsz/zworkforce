...
// Build TOML config for zRouter (openai provider mode)
const buildzRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect zRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildzRouterConfig(baseUrl, apiKey || "sk_zrouter", model);
