/**
 * `zrouter xai video` — generate a Grok Imagine video through the local
...
const HELP = `
Usage: zrouter xai video --prompt "..." [options]
...
Options:
  ...
  --api-key <key>         zrouter API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-zrouter-connection-id"] || null;
