<div align="center">
  <img src="./images/zrouter.png?1" alt="zRouter Dashboard" width="800"/>
  
  # zRouter - FREE AI Router & Token Saver
  ...
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  ...
  [![License](https://img.shields.io/npm/l/zrouter.svg)](https://github.com/decolua/zrouter/blob/main/LICENSE)
...
[🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://zrouter.com)
...
🎉 Dashboard opens at `http://localhost:20128` (or your configured public URL)
...
```bash
npm run build
PORT=20128 HOSTNAME=0.0.0.0 NEXT_PUBLIC_BASE_URL=https://your-domain.com npm run start
```
...
> **Production:** Set `NEXT_PUBLIC_BASE_URL` to your public HTTPS URL (e.g. `https://zgw.zeaz.dev`). The app adds enterprise security headers (HSTS, X-Frame-Options DENY, Permissions-Policy) automatically in production.
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với zRouter<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>zRouter + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>zRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with zRouter 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + zRouter<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup zRouter 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy zRouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + zRouter: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>by <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
    </td>
...
> 🎬 **Made a video about zRouter?** Submit a [Pull Request](https://github.com/decolua/zrouter/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

zRouter works seamlessly with all major AI coding tools:
...
Set `X-zRouter-Token-Saver: off` to bypass all token savers for one chat request.
...
Headroom is optional and runs separately. zRouter calls Headroom's local `/v1/compress` endpoint, then keeps normal routing, fallback, auth, and usage tracking:

```
Client → zRouter → Headroom /v1/compress → zRouter → provider
```
...
If Headroom is down or returns an error, zRouter fails open and sends the original request.
...
- Your CLI tool sends OpenAI format → zRouter translates → Provider receives native format
...
> zRouter itself **never charges** you anything. You only pay providers directly (if using paid services).
>
...
### 📊 Understanding zRouter Costs & Billing

**zRouter Billing Reality:**

✅ **zRouter software = FREE forever** (open source, never charges)  
...
❌ **zRouter never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, zRouter just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **zRouter**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through zRouter.
...
<details>
<summary><b>💳 Will I be charged by zRouter?</b></summary>

**No.** zRouter is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**

- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, zRouter just routes your requests
- ❌ **zRouter itself** → **Never charges anything, ever**

zRouter is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
zRouter just routes your requests to them - there's no "catch" or future billing from zRouter itself. They're truly free services, and zRouter makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - zRouter helps maximize their value through quota tracking
...
zRouter's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and zRouter respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. zRouter tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from zrouter dashboard]
...
> **Note:** OpenClaw only works with local zRouter. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
- Docker Hub: [`decolua/zrouter`](https://hub.docker.com/r/decolua/zrouter)
...
docker pull decolua/zrouter:latest   # update to latest
```

**Data persistence:** `$HOME/.zrouter/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable                                             | Default                                  | Description                                                                         |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET`                                         | Auto-generated (`~/.zrouter/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances)   |
| `INITIAL_PASSWORD`                                   | `123456`                                 | First login password when no saved hash exists                                      |
| `DATA_DIR`                                           | `~/.zrouter`                             | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`)                       |
| `PORT`                                               | framework default                        | Service port (`20128` in examples)                                                  |
| `HOSTNAME`                                           | framework default                        | Bind host (Docker defaults to `0.0.0.0`)                                            |
| `NODE_ENV`                                           | runtime default                          | Set `production` for deploy                                                         |
| `BASE_URL`                                           | `http://localhost:20128`                 | Server-side internal base URL used by cloud sync jobs                               |
| `CLOUD_URL`                                          | `https://zrouter.com`                    | Server-side cloud sync endpoint base URL                                            |
| `NEXT_PUBLIC_BASE_URL`                               | `http://localhost:3000`                  | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime)          |
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://zrouter.com`                    | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime)        |
...
- Both `${DATA_DIR}` and `~/.zrouter` resolve to the same location in a Docker container — the symlink `/root/.zrouter -> /app/data` is created at build time.
...
- Set `PORT=20128` and `NEXT_PUBLIC_BASE_URL=http://localhost:20128` (or your public HTTPS URL)
...
> Replace `localhost:20128` with your public URL if accessing remotely (e.g. `https://zgw.zeaz.dev`).
...
Thanks to all contributors who helped make zRouter better!

[![Contributors](https://contrib.rocks/image?repo=decolua/zrouter&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/zrouter/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/decolua/zrouter.svg?variant=adaptive)](https://starchart.cc/decolua/zrouter)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of zRouter. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. zRouter ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. zRouter adapts its prompt → **−65% output tokens**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) by **[@DietrichGebert](https://github.com/DietrichGebert)** — _"lazy senior dev"_ skill. zRouter injects its YAGNI-first ladder → **fewer tokens, less code, shorter diffs**.

Huge thanks to these authors — without their work, zRouter's token-saving features wouldn't exist. ⭐ them on GitHub!
